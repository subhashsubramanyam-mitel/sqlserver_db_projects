...
CREATE VIEW [dbo].[V_AX_Invoice_SKU2]
AS
...
left join custinvoicetrans_PM b on a.invoiceid = b.invoiceid
left join SVLCORPAXDB1.PROD.dbo.salestable c on a.salesid = c.salesid
left join salesline_PM d on c.salesid = d.salesid and d.itemid = b.itemid AND d.inventtransid = b.inventtransid 
left join salesline_PM e on d.salesid = e.salesid and d.semsbeparent = e.inventtransid
