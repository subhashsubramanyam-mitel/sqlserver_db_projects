CREATE TABLE [dbo].[POS_RAW_TD] (
    [Created]        DATETIME        CONSTRAINT [DF_POS_RAW_TD_Created] DEFAULT (getdate()) NOT NULL,
    [Id]             INT             IDENTITY (1, 1) NOT NULL,
    [Invoice]        VARCHAR (100)   NULL,
    [VADId]          VARCHAR (15)    CONSTRAINT [DF_POS_RAW_TD_VAD_ID] DEFAULT ((735129)) NOT NULL,
    ...
    CONSTRAINT [PK_POS_RAW_TD] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
GRANT SELECT
    ON OBJECT::[dbo].[POS_RAW_TD] TO [POS]
    AS [dbo];
