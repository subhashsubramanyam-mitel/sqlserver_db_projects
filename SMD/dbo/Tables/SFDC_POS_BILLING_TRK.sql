CREATE TABLE [dbo].[SFDC_POS_BILLING_TRK] (
    [Created]               DATETIME         CONSTRAINT [DF_SFDC_POS_BILLING_TRK_Created] DEFAULT (getdate()) NULL,
    ...
    [Status]                VARCHAR (5)      CONSTRAINT [DF_SFDC_POS_BILLING_TRK_Status] DEFAULT ('N') NULL,
    [ErrorMsg]              TEXT             NULL,
    [Margin]                NUMERIC (18, 12) NULL,
    [VadId]                 VARCHAR (15)     NULL,
    [NetSalesPlanRate]      NUMERIC (18, 12) NULL,
    CONSTRAINT [PK_SFDC_POS_BILLING_TRK] PRIMARY KEY CLUSTERED ([RecId] ASC)
);
