CREATE TABLE [dbo].[POS_CI_ING] (
    [Created]        DATETIME        CONSTRAINT [DF_POS_CI_ing_Created] DEFAULT (getdate()) NOT NULL,
    [Id]             INT             IDENTITY (1, 1) NOT NULL,
    [Invoice]        VARCHAR (100)   NULL,
    [VADId]          VARCHAR (15)    CONSTRAINT [DF_POS_CI_ing_VAD_ID] DEFAULT ((736458)) NOT NULL,
    ...
    CONSTRAINT [PK_POS_CI_ING] PRIMARY KEY CLUSTERED ([Id] ASC)
);
