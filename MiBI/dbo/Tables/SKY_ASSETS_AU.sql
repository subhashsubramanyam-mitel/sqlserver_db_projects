CREATE TABLE [dbo].[SKY_ASSETS_AU] (
    [Created]             DATETIME       CONSTRAINT [DF_SKY_ASSETS_AU_Created] DEFAULT (getdate()) NULL,
    ...
    [ErrStatus]           CHAR (1)       CONSTRAINT [DF_SKY_ASSETS_AU] DEFAULT ('N') NULL,
    [ErrorTxt]            TEXT           NULL,
    CONSTRAINT [PK_SKY_ASSETS_AU] PRIMARY KEY CLUSTERED ([M5DBServiceId] ASC)
);
