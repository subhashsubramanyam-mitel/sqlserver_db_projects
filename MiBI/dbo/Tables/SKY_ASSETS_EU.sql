CREATE TABLE [dbo].[SKY_ASSETS_EU] (
    [Created]             DATETIME       CONSTRAINT [DF_SKY_ASSETS_EU_Created] DEFAULT (getdate()) NULL,
    ...
    [ErrStatus]           CHAR (1)       CONSTRAINT [DF_SKY_ASSETS_EU] DEFAULT ('N') NULL,
    [ErrorTxt]            TEXT           NULL,
    CONSTRAINT [PK_SKY_ASSETS_EU] PRIMARY KEY CLUSTERED ([M5DBServiceId] ASC)
);
