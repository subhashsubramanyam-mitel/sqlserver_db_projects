CREATE TABLE [dbo].[SkySFDCAccount] (
    [Created]          DATETIME        CONSTRAINT [DF_SkySFDCAccount_Created] DEFAULT (getdate()) NOT NULL,
    ...
    [Status]           VARCHAR (10)    CONSTRAINT [DF_SkySFDCAccount_Status] DEFAULT ('N') NULL,
    [ErrMsg]           VARCHAR (500)   NULL,
    [FirstInvoice]     DATETIME        NULL,
    [ProfileCount]     VARCHAR (15)    CONSTRAINT [DF_SkySFDCAccount_ProfileCount] DEFAULT ((0)) NULL,
    CONSTRAINT [PK_SkySFDCAccount] PRIMARY KEY CLUSTERED ([AccountId] ASC)
);
