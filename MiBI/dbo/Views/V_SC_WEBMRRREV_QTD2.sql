/*
CREATE VIEW [dbo].[V_SC_WEBMRRREV_QTD2]
AS
...
Where CloseDate BETWEEN dateadd(qq, datediff(qq, 0, '10-1-2015'), 0) and dateadd(qq, datediff(qq, 0, '10-1-2015')+1, 0)
...
from dbo.V_SC_MRRBilling
Where CloseDate BETWEEN dateadd(qq, datediff(qq, 0, '10-1-2015')+1, 0) and dateadd(qq, datediff(qq, 0, '10-1-2015')+2, 0)
Group by ImpactNumber
...
from dbo.V_SC_MRRBilling
Where CloseDate BETWEEN dateadd(qq, datediff(qq, 0, '10-1-2015')+2, 0) and dateadd(qq, datediff(qq, 0, '10-1-2015')+3, 0)
Group by ImpactNumber
...
from dbo.V_SC_MRRBilling
Where CloseDate BETWEEN dateadd(qq, datediff(qq, 0, '10-1-2015')+3, 0) and dateadd(qq, datediff(qq, 0, '10-1-2015')+4, 0)
Group by ImpactNumber
