...
CREATE  VIEW [dbo].[V_SKY_ASSETSYNC_AU]
AS
SELECT  --top 10000
a.Id,  
a.CiId,
...
'AU-'+a.Accountid as m5db__Account__c,
...
'AU-'+rtrim(convert(varchar(15),a.M5DBServiceId))				as m5db__service_id__c,
...
--,cc.CurrencyCode,
'AUD' as CurrencyCode,  --Hard Coding
a.M5DBServiceId -- for trk table
FROM         
		SKY_ASSETS_AU a inner join
		CUSTOMERS b on 'AU-'+a.Accountid = b.M5DBAccountID  inner join
