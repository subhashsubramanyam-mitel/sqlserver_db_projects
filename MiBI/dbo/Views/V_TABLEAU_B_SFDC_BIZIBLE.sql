...
CREATE view [dbo].[V_TABLEAU_B_SFDC_BIZIBLE] as
...
Select
		...
		,bat.BIZIBLE2__TOUCHPOINT_DATE__C as [Touchpoint Date (BAT)]
		,bt.BIZIBLE2__TOUCHPOINT_DATE__C as [Touchpoint Date (BT)]
