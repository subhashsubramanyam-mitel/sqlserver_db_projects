create view support.VwAgentScorecard_T1_India as
Select distinct a.[Name], a.RoleName,b.[Closed Cases],c.[Case Age],d.[Backlog],e.[Mitel Responsibility],
...
Left join support.VwAgentECC1 i on lower(a.Email)=lower(i.UserEmail)
