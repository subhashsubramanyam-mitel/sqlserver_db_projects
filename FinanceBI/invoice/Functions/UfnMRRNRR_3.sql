...
-- SS	2020-12-06	Replaced Subquery aliased A in second part of the query with [invoice].[IncrMRRbase_EX_Aggregate] 
-- =============================================
CREATE FUNCTION [invoice].[UfnMRRNRR_3] (
	@FromDate DATE
	,-- includes
...
RETURN (
		...
		LEFT JOIN [invoice].[IncrMRRbase_EX_Aggregate] A ON A.AccountId = MB.AccountId
