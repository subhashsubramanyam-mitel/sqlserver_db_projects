CREATE TABLE [PCSandbox].[UsageInclusionTable] (
    ...
    CONSTRAINT [PK_UsageInclusionTable] PRIMARY KEY CLUSTERED ([ChargeDescription] ASC)
);


GO

CREATE TRIGGER PCSandbox.TG_UsageInclusionTable
   ON  PCSandbox.UsageInclusionTable
...
PCSandbox.UsageInclusionTable c inner join deleted d
    on c.Id = d.Id;
  ...
  from
   PCSandbox.UsageInclusionTable c inner join inserted i
    on c.Id = i.Id;
  end;
 end;
