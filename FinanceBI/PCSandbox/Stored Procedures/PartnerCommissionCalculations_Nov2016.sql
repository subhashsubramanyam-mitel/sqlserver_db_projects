...
-- =============================================
CREATE PROCEDURE [PCSandbox].[PartnerCommissionCalculations_Nov2016]
...
BEGIN
	...
	*/
		...
		update PCSandbox.[RawDataWCalcs]
		 ...
		 inner join PCSandbox.[RawDataWCalcs] rd
		 on rd.[CreditingPartnerId] = prt.[LichenPartnerID]
