CREATE TABLE [commission].[History_PartnerCommission] (
    [PCMonth]                         DATE            NULL,
...
GO
CREATE CLUSTERED INDEX [InvoiceMonth_PartnerId_Partner_Cldx]
    ON [commission].[History_PartnerCommission]([InvoiceMonth] ASC, [CreditingPartnerId] ASC, [CreditingPartner] ASC);
