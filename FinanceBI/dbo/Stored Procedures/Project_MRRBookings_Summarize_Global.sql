...
CREATE PROCEDURE [dbo].[Project_MRRBookings_Summarize_Global]
AS
-- =============================================
-- Author:		<Payal Mukhi>
-- Create date: <05/24/2016>
-- Description:	<Description,,>
-- MW updated to create global table 12072016
-- =============================================
...
insert into [Project_MRRBookings_Summary_Global]
([Fiscal Quarter]
           ,[WeekBucket]
           ,[Total Booked]
    )
...
---------------------------------
Update [Project_MRRBookings_Summary_Global]
