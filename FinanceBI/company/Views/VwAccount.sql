...
CREATE VIEW [company].[VwAccount]
AS
SELECT     A.Id AS [Ac Id], dbo.UfnRemoveUnprintableChar(A.Name)  AS [Ac Name], 
A.ParentAccountId, A.LichenAccountId, A.PartnerId,
 ...
 AM.SfdcTerritoryId
 ,AA.IsMCSSEnabled
 -- need Str MW 10072020
 ,convert(Varchar(10), A.Id ) collate Latin1_General_BIN as AccountId_str 
