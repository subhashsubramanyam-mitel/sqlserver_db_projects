...
CREATE CLUSTERED INDEX [ClusteredIndex-date]
    ON [ax].[SalesLine]([SHIPPINGDATEREQUESTED] ASC);


GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-SalesID-Linenum]
    ON [ax].[SalesLine]([SALESID] ASC, [LINENUM] ASC);
