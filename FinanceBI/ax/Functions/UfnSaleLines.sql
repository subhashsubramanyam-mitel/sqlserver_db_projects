...
-- Create date: June 9, 2017
-- Description:	View of AX Sales Lines
-- Change Log: 
--     2016-02-23 Using materialized view for performance
-- =============================================
CREATE FUNCTION ax.[UfnSaleLines] 
(	
	@FromDate  Date, -- inclusive from date
	@ToDate Date   --- excluding to date
)
RETURNS TABLE 
AS
RETURN 
(
	...
	where SL.SHIPPINGDATEREQUESTED >= @FromDate -- inclusive
		and SL.SHIPPINGDATEREQUESTED < @ToDate   -- excluding to date
